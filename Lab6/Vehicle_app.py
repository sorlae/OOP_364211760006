...
def input_vehicle_data():
    ...
    max_speed = int(input("Enter vehicle max speed: "))
    price = float(input("Enter vehicle price: "))

    #return brand,model,color,max_speed,price # return as tuple
    my_vehicle.append(Vehicle(brand,model,color,max_speed,price))
    print("\n-----------------------------------")
